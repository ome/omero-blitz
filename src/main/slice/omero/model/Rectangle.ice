    ...
    **
    */
 #ifndef RECTANGLE_ICE
 #define RECTANGLE_ICE
 ...
 module omero {
   module model {
     ...
     extends omero::model::Shape
     {
       ...
       omero::RDouble width;
       omero::RDouble getWidth();
       void setWidth(omero::RDouble theWidth);
       omero::RDouble height;
       omero::RDouble getHeight();
       void setHeight(omero::RDouble theHeight);
